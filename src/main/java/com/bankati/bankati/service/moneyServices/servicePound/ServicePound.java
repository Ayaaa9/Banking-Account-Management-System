package com.bankati.bankati.service.moneyServices.servicePound;
...
public class ServicePound implements IMoneyService {
    ...
    public MoneyData convertData(Long userId) {
        ...
        if (userOpt.isPresent()) {
            ...
            if (solde != null) {
                double result = solde.convertTo(Devise.POUND);
                return new MoneyData(result, Devise.POUND);
            }
        }

        return new MoneyData(0.0, Devise.POUND);
    }
}
